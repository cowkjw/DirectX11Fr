...
HRESULT CLoader::Loading_For_Logo()
{
	...
	if (FAILED(m_pGameInstance->Add_Prototype(ToIndex(LEVEL::LEVEL_LOGO), TEXT("Prototype_Component_Texture_BackGround"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(ToIndex(LEVEL::LEVEL_LOGO), TEXT("Prototype_GameObject_BackGround"),
